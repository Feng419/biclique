...
struct biGraph {
    ...
    std::vector<std::vector<pii> > nei[2], tnei[2], onei[2]; 
    ...
    void read(const std::string & filepath, const std::string & core, const std::string & order, int size, int k) {
        ...
        if (order == "no" || order == "deg") {
            ...
            // e[0] = std::move(e1);
            // e[1] = std::move(e2);
            // for (int u : p[0]) printf("%d ", u);
            // for (int u : p[1]) printf("%d ", u);
            ...
            // for (int i = 0; i < n1; ++i) {
            //     nei[0].emplace_back(returnnei(i, 0));
            //     for (auto u : nei[0][i]) printf("%d ", u.first);
            //     printf("\n");
            // }
            // for (int i = 0; i < n2; ++i) {
            //     nei[1].emplace_back(returnnei(i, 1));
            // }
            // for (int i = 0; i < n1 + n2; ++i) {
            //     printf("nei[0][%d]: ", i);
            //     for (auto u : nei[0][i]) printf("%d ", u.first);
            ...
            // for (int i = 0; i < n1 + n2; ++i) {
            //     printf("nei[1][%d]: ", i);
            //     for (auto u : nei[1][i]) printf("%d ", u.first);
            //     printf("\n");
            // }
        } else if (order == "core") {
            //printf("333\n");
            ...
            // for (int i = 0; i < n1 + n2; ++i) {
            //     printf("nei: ");
            //     for (auto u : neighbor(i)) printf("%d ", u.first);
            //     printf("\n");
            // }
        }
        // std::cout << "n1: " << n1 << ", n2: " << n2 << ", m: " << m << std::endl;
    ...
    std::vector<pii> neighbor(const int u) {
        std::vector<pii> S;
        for (int uu : edge[u]) {
            S.push_back(mp(uu, 0));
        }
    ...
    std::vector<pii> returnnei(int u, int t) {
        std::vector<pii> s;
        for (int x = p[t][u]; x < p[t][u + 1]; ++x) {
            s.emplace_back(mp(e[t][x], 0));
        }
        return s;
    }
